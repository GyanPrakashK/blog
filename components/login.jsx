            ...
            <div className=' h-[100vh]   flex justify-center items-center'>
                ...
                <form className="bg-white py-8 px-10 rounded-2xl shadow-md w-96" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div onClick={() => { setLoginOrNot(!loginOrNot) }} className=" text-right hover:cursor-pointer  mt-2">
                        <div >{loginOrNot ? <div className=' flex '>Don&apos;t have account? <div className='text-blue-700 hover:underline'>Register </div></div> : <div className=' flex '>Already have account? <div className='text-blue-700 hover:underline'>Login </div></div>}
                        </div>
                    </div>
                </form>
            </div>
